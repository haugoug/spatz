...
void TEST_CASE1() {
  ...
  VSET(16, e16, m8);
  VLOAD_16(v0, 0xbb1e, 0xb573, 0x39dc, 0xb97a, 0xb4c0, 0xba31, 0x3897, 0x36ee,
           0x3b27, 0xb7d7, 0x36c0, 0x376c, 0x395b, 0x3703, 0x3057, 0x0001);
  asm volatile("vfmv.f.s %0, v0" : "=f"(scalar_16b));
  XCMP(1, *((uint16_t *)&scalar_16b), 0xbb1e);

  scalar_32b = 0;
  VSET(16, e32, m8);
  VLOAD_32(v0, 0xbe9451b0, 0x3ece4bf7, 0x3eadc098, 0x3f09f4f0, 0x3ecc80cc,
           0xbe8a42c5, 0x3f47fd31, 0xbe201365, 0xbeffeb17, 0xbf314e2e,
           0xbd0a9c78, 0xbf1fb51f, 0x3b5e1209, 0x3eac9a73, 0xbeb187b6,
           0x3dea828d);
  asm volatile("vfmv.f.s %0, v0" : "=f"(scalar_32b) );
  XCMP(2, *((uint32_t *)&scalar_32b), 0xbe9451b0);

  scalar_64b = 0;

  VSET(16, e64, m8);
  VLOAD_64(v0, 0xbfe8d9d3f67536d2, 0x3fdad9e3e9cdd5bc, 0xbfd90875fda29450,
           ...
           0xbfdc0cda147fbe5c);
  asm volatile("vfmv.f.s %0, v0" : "=f"(scalar_64b));
